...
public class Feed {
    ...
    private org.xiao.rss.Location location = null;

    private java.util.Date lastUpdate = null;
    private Integer interval = null;
    
    private java.util.ArrayList<org.xiao.rss.Item> items = new java.util.ArrayList<org.xiao.rss.Item>();
   ...
   *  document. 
   */ 
    protected Feed(Node node, java.util.HashMap<String, String> namespaces) {
        ...
        for (int i=0; i<nodeList.getLength(); i++){
            ...
            if (node.getNodeType()==1){
              ...
              //Parse Location Information (GeoRSS)
                    ...
                    items.add(new org.xiao.rss.Item(node, namespaces));
                }
   ...
   */ 
    public org.xiao.rss.Item[] getItems(){
        return items.toArray(new org.xiao.rss.Item[items.size()]);
    }
   ...
   */ 
    public void addItem(org.xiao.rss.Item item){
        items.add(item);
    }
